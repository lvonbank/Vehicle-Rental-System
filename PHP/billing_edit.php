...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "billing_edit";
...
$page_layouts["billing_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "billing_list";
...
$page_layouts["billing_list"] = $layout;
...
$keys = array();
$keys["Bill_ID"] = postvalue("editid1");
