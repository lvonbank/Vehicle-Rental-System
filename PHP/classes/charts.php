...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("address" == $this->chrt_array['tables'][0])
			return true;
		if("billing" == $this->chrt_array['tables'][0])
			return true;
		if("booking" == $this->chrt_array['tables'][0])
			return true;
		if("customer" == $this->chrt_array['tables'][0])
			return true;
		if("discount" == $this->chrt_array['tables'][0])
			return true;
		if("instock" == $this->chrt_array['tables'][0])
			return true;
		if("location" == $this->chrt_array['tables'][0])
			return true;
		if("payment" == $this->chrt_array['tables'][0])
			return true;
		if("vehicle" == $this->chrt_array['tables'][0])
			return true;
		if("billing" == $this->chrt_array['tables'][0])
			return true;
		return false;
