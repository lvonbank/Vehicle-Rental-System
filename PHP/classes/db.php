...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "vehiclerental_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "address", "varname" => "vehiclerental_at_localhost__address", "altvarname" => "address", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "billing", "varname" => "vehiclerental_at_localhost__billing", "altvarname" => "billing", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "booking", "varname" => "vehiclerental_at_localhost__booking", "altvarname" => "booking", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "customer", "varname" => "vehiclerental_at_localhost__customer", "altvarname" => "customer", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "discount", "varname" => "vehiclerental_at_localhost__discount", "altvarname" => "discount", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "instock", "varname" => "vehiclerental_at_localhost__instock", "altvarname" => "instock", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "location", "varname" => "vehiclerental_at_localhost__location", "altvarname" => "location", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "login", "varname" => "vehiclerental_at_localhost__login", "altvarname" => "login", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "payment", "varname" => "vehiclerental_at_localhost__payment", "altvarname" => "payment", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
			$dalTables[$conn->connId][] = array("name" => "vehicle", "varname" => "vehiclerental_at_localhost__vehicle", "altvarname" => "vehicle", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		}
	}
