...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "address" ] = array( "url" => "address", "type" => 0 );
	$projectEntitiesReverse[ "address" ] = "address";
	$projectEntities[ "billing" ] = array( "url" => "billing", "type" => 0 );
	$projectEntitiesReverse[ "billing" ] = "billing";
	$projectEntities[ "booking" ] = array( "url" => "booking", "type" => 0 );
	$projectEntitiesReverse[ "booking" ] = "booking";
	$projectEntities[ "customer" ] = array( "url" => "customer", "type" => 0 );
	$projectEntitiesReverse[ "customer" ] = "customer";
	$projectEntities[ "discount" ] = array( "url" => "discount", "type" => 0 );
	$projectEntitiesReverse[ "discount" ] = "discount";
	$projectEntities[ "instock" ] = array( "url" => "instock", "type" => 0 );
	$projectEntitiesReverse[ "instock" ] = "instock";
	$projectEntities[ "location" ] = array( "url" => "location", "type" => 0 );
	$projectEntitiesReverse[ "location" ] = "location";
	$projectEntities[ "payment" ] = array( "url" => "payment", "type" => 0 );
	$projectEntitiesReverse[ "payment" ] = "payment";
	$projectEntities[ "vehicle" ] = array( "url" => "vehicle", "type" => 0 );
	$projectEntitiesReverse[ "vehicle" ] = "vehicle";
	$projectEntities[ "revenue_by_location" ] = array( "url" => "revenue_by_location", "type" => 2 );
	$projectEntitiesReverse[ "revenue_by_location" ] = "revenue_by_location";
}
