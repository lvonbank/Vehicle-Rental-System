...
class tDAL
{
	var $tblvehiclerental_at_localhost__address;
	var $tblvehiclerental_at_localhost__billing;
	var $tblvehiclerental_at_localhost__booking;
	var $tblvehiclerental_at_localhost__customer;
	var $tblvehiclerental_at_localhost__discount;
	var $tblvehiclerental_at_localhost__instock;
	var $tblvehiclerental_at_localhost__location;
	var $tblvehiclerental_at_localhost__login;
	var $tblvehiclerental_at_localhost__payment;
	var $tblvehiclerental_at_localhost__vehicle;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "address", "varname" => "vehiclerental_at_localhost__address", "altvarname" => "address", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "billing", "varname" => "vehiclerental_at_localhost__billing", "altvarname" => "billing", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "booking", "varname" => "vehiclerental_at_localhost__booking", "altvarname" => "booking", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "customer", "varname" => "vehiclerental_at_localhost__customer", "altvarname" => "customer", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "discount", "varname" => "vehiclerental_at_localhost__discount", "altvarname" => "discount", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "instock", "varname" => "vehiclerental_at_localhost__instock", "altvarname" => "instock", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "location", "varname" => "vehiclerental_at_localhost__location", "altvarname" => "location", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "login", "varname" => "vehiclerental_at_localhost__login", "altvarname" => "login", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "payment", "varname" => "vehiclerental_at_localhost__payment", "altvarname" => "payment", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
		$this->lstTables[] = array("name" => "vehicle", "varname" => "vehiclerental_at_localhost__vehicle", "altvarname" => "vehicle", "connId" => "vehiclerental_at_localhost", "schema" => "", "connName" => "vehiclerental at localhost");
	}
