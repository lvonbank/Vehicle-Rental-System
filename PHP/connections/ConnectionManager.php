...
class ConnectionManager
{
	...
	{
		return $this->byId( "vehiclerental_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "vehiclerental_at_localhost";
		$data["connName"] = "vehiclerental at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;vehiclerental;;1"; //currently unused

		$this->_connectionsIdByName["vehiclerental at localhost"] = "vehiclerental_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "vehiclerental";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=vehiclerental;OPTION=3";
		// encription set
		...
		$connectionsData["vehiclerental_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["address"] = "vehiclerental_at_localhost";
		$connectionsIds["billing"] = "vehiclerental_at_localhost";
		$connectionsIds["booking"] = "vehiclerental_at_localhost";
		$connectionsIds["customer"] = "vehiclerental_at_localhost";
		$connectionsIds["discount"] = "vehiclerental_at_localhost";
		$connectionsIds["instock"] = "vehiclerental_at_localhost";
		$connectionsIds["location"] = "vehiclerental_at_localhost";
		$connectionsIds["payment"] = "vehiclerental_at_localhost";
		$connectionsIds["vehicle"] = "vehiclerental_at_localhost";
		$connectionsIds["revenue_by_location"] = "vehiclerental_at_localhost";
