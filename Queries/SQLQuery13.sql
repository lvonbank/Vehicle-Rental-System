...
IF OBJECT_ID('StopBookingOverlap') IS NOT NULL 
BEGIN
DROP TRIGGER dbo.StopBookingOverlap;
END;

GO

CREATE TRIGGER StopBookingOverlap
ON Booking
AFTER INSERT, UPDATE
AS
IF EXISTS (SELECT *  
...
BEGIN
RAISERROR ('Rental dates overlaps with another for this vehicle.', 16, 1);  
